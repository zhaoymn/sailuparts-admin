...
export async function updateArtist(id: string, data: string) {
  try {
    ...
    const updatedArtist = await Artist.findByIdAndUpdate(id, {
      ...
      short_description: artistData.short_description,
      key_points: {
        education: artistData.key_points.education,
        current_profession: artistData.key_points.current_profession,
        best_achievement: artistData.key_points.best_achievement,
      },
      bio: artistData.bio,
      bio_chinese: artistData.bio_chinese,
      awards: artistData.awards,
      exhibitions: artistData.exhibitions,
      publications: artistData.publications,
      external_links: artistData.external_links,
      external_link_names: artistData.external_link_names,
